                            ...
                            <form>
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        <input id="ProductName" value={this.state.ProductName} name="ProductName" placeholder="Product Name" className="form-control" type="text" onChange={(e)=>this.onChangeInput(e)} />
                                    </div>
                                    <div className="form-group col-md-6">
                                        <input id="ProductQuantity" value={this.state.ProductQuantity} name="ProductQuantity" placeholder="Product Quantity" className="form-control" type="text" onChange={(e)=>this.onChangeInput(e)} />
                                    </div>

                                </div>
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        <input id="RegistrationNumber" value={this.state.RegistrationNumber} name="RegistrationNumber" placeholder="Registration number" className="form-control" required="required" type="text" onChange={(e)=>this.onChangeInput(e)}/>
                                    </div>
                                    <div className="form-group col-md-6">

                                        <select id="Category" value={this.state.Category} name="Category" className="form-control" onChange={(e)=>this.onChangeInput(e)}>
                                    ...
                                    <div className="form-group col-md-6">
                                        <select id="Price" name="Price" value={this.state.Price} className="form-control" onChange={(e)=>this.onChangeInput(e)}>
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <select id="Area" value={this.state.Area} name="Area" className="form-control" onChange={(e)=>this.onChangeInput(e)}>
                                        ...
                                        <div className="form-group col-md-12">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="col-md-4">
                                                    <input name="filebutton1" value={this.state.filebutton1} className="input-file" id="filebutton1" type="file" onChange={(e)=>this.onChangeInput(e)}/>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="col-md-4 control-label" for="filebutton">Image2</label>
                                                <div className="col-md-4">
                                                    <input name="filebutton2" value={this.state.filebutton2} className="input-file" id="filebutton2" type="file" onChange={(e)=>this.onChangeInput(e)}/>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="col-md-4 control-label" for="filebutton">Image3</label>
                                                <div className="col-md-4">
                                                    <input name="filebutton3" value={this.state.filebutton3} className="input-file" id="filebutton3" type="file" onChange={(e)=>this.onChangeInput(e)}/>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="col-md-4 control-label" for="filebutton">Image4</label>
                                                <div className="col-md-4">
                                                    <input name="filebutton4" value={this.state.filebutton4} className="input-file" id="filebutton4" type="file" onChange={(e)=>this.onChangeInput(e)}/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group col-md-12">
                                        ...
                                        <textarea id="comment" name="comment" value={this.state.comment} cols="40" rows="5" className="form-control" onChange={(e)=>this.onChangeInput(e)}></textarea>
                                    </div>
